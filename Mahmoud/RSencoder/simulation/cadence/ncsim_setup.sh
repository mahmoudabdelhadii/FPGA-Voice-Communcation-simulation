...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_highspeed_rs_enc_lagr_pkg.sv" -work encoder        -cdslib ./cds_libs/encoder.cds.lib       
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/RSencoder_highspeed_rs_0.v"          -work highspeed_rs_0 -cdslib ./cds_libs/highspeed_rs_0.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/RSencoder.v"                                                                                                  
fi
