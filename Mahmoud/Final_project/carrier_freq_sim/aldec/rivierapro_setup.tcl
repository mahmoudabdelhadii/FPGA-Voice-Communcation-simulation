...
# ACDS 16.1 196 win32 2021.06.08.13:33:45
# ----------------------------------------
...
# ----------------------------------------
# If carrier_freq is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "carrier_freq"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/carrier_freq.vo"
}
