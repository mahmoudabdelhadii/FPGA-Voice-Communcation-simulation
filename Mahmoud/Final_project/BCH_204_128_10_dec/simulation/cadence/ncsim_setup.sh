...
TOP_LEVEL_NAME="BCH_204_128_10_dec"
QSYS_SIMDIR="./../"
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/bchp_invmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/bchp_parameters.vhd"   -work bch_0 -cdslib ./cds_libs/bch_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/bchp_roots.vhd"        -work bch_0 -cdslib ./cds_libs/bch_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/bchp_auto_package.vhd" -work bch_0 -cdslib ./cds_libs/bch_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/bchp_mb_system.vhd"    -work bch_0 -cdslib ./cds_libs/bch_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/top_dec.vhd"           -work bch_0 -cdslib ./cds_libs/bch_0.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/BCH_204_128_10_dec.v"                                                         
fi
