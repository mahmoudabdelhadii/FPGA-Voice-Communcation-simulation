...
TOP_LEVEL_NAME="BCH_204_128_10_enc"
QSYS_SIMDIR="./../"
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/bch_enc_package.vhd" -work bch_0 -cdslib ./cds_libs/bch_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/top_enc.vhd"         -work bch_0 -cdslib ./cds_libs/bch_0.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/BCH_204_128_10_enc.v"                                                       
fi
