...
# ----------------------------------------
# If BCH_204_128_10_enc is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 196 win32 2021.06.08.00:17:20
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "BCH_204_128_10_enc"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/bch_enc_package.vhd"         -work bch_0
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/bch_encoder_core.vhd" -work bch_0
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/bch_encoder.vhd"      -work bch_0
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/top_enc.vhd"                 -work bch_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/BCH_204_128_10_enc.v"                              
}
