...
mkdir -p ./libraries/highspeed_rs_0/
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/rsx_decoder_rom_inverse.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/rsx_parameters_auto.vhd"    -work decoder        -cdslib ./cds_libs/decoder.cds.lib       
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/rsx_roots_auto.vhd"         -work decoder        -cdslib ./cds_libs/decoder.cds.lib       
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/rsx_bm_auto.vhd"            -work decoder        -cdslib ./cds_libs/decoder.cds.lib       
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/rsx_inverse_ROM_auto.vhd"   -work decoder        -cdslib ./cds_libs/decoder.cds.lib       
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/RSdecoder_highspeed_rs_0.v" -work highspeed_rs_0 -cdslib ./cds_libs/highspeed_rs_0.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/RSdecoder.v"                                                                                         
fi
