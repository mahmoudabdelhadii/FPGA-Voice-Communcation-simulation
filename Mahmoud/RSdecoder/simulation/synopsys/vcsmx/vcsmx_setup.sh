...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/rsx_parameters_auto.vhd"    -work decoder       
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/rsx_roots_auto.vhd"         -work decoder       
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/rsx_bm_auto.vhd"            -work decoder       
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/rsx_inverse_ROM_auto.vhd"   -work decoder       
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/submodules/RSdecoder_highspeed_rs_0.v" -work highspeed_rs_0
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/RSdecoder.v"                                               
fi
