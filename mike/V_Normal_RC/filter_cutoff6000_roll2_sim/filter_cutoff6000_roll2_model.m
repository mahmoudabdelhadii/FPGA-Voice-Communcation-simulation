...
% ================================================================================
% Generated on: 06/10/2021 01:40:37
...
for j = 1:sx
    ...
    %
    file_name = ['filter_cutoff6000_roll2_input.txt'];
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = filter_cutoff6000_roll2_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['filter_cutoff6000_roll2_model_output'];
