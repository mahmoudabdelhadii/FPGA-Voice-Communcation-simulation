...
function  output = filter_cutoff6000_roll2_mlab(stimulation, bank);
 coef_matrix_in= [0,0,0,0,0,1,3,4,0,-8,-17,-16,0,34,77,112,127,112,77,34,0,-16,-17,-8,0,4,3,1,0,0,0,0,0];
 INTER_FACTOR  = 1;
 DECI_FACTOR  =  1;
 MSB_RM  = 0;
 MSB_TYPE  = 0;
