// -------------------------------------------------------------
// 
// File Name: C:\UBC Summer 2021\gitproject\ELEC391_Final_Project\mike\V_Normal_RC\Filter_for_16PSK\hdlcoder\receive3\gm_gm_Modulation_test\Raised_Cosine_Receive_Filter.v
...
module Raised_Cosine_Receive_Filter
  ...
  wire enb_1_1_1;
  wire enb_1_8_1;
  wire signed [15:0] FIR_Decimation_out1;  // int16
  ...
  FIR_Decimation u_FIR_Decimation (.clk(clk),
                                   .enb_1_1_1(enb_1_1_1),
                                   .reset(reset),
                                   .FIR_Decimation_in(In1),  // int16
                                   .FIR_Decimation_out(FIR_Decimation_out1)  // int16
                                   );
