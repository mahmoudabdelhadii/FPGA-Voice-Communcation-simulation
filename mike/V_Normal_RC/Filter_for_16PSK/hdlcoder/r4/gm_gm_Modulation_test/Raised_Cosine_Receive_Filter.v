// -------------------------------------------------------------
// 
// File Name: C:\UBC Summer 2021\gitproject\ELEC391_Final_Project\mike\V_Normal_RC\Filter_for_16PSK\hdlcoder\r4\gm_gm_Modulation_test\Raised_Cosine_Receive_Filter.v
// Created: 2021-06-16 12:12:22
// 
...
module Raised_Cosine_Receive_Filter
  ...
  FIR_Decimation u_FIR_Decimation (.clk(clk),
                                   .enb_1_1_1(enb_1_1_1),
                                   .reset(reset),
                                   .FIR_Decimation_in(In1),  // uint32
                                   .FIR_Decimation_out(FIR_Decimation_out1)  // int32
                                   );

  assign Data_Type_Conversion_out1 = FIR_Decimation_out1;
