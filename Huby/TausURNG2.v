// -------------------------------------------------------------
// 
// File Name: C:\Users\huber\Downloads\hdlsrc\HDLAWGNGenerator\HDLAWGNGenerator\TausURNG2.v
...
module TausURNG2
  ...
  always @(posedge clk or posedge reset)
    begin : Delay_process
      if (reset == 1'b1) begin
        Delay_out1 <= 32'b00000000000000000000100100100111;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : Delay1_process
      if (reset == 1'b1) begin
        Delay1_out1 <= 32'b00000000000000000000000101000011;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : Delay2_process
      if (reset == 1'b1) begin
        Delay2_out1 <= 32'b00000000000000000000001101000001;
      end
      else begin
        if (enb) begin
  ...
  assign b = Bitwise_Operator9_out1;
